        ...
        <section>
            ...
            <ul class="lista-items">
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/mike.jpg" alt="Mike">
                        </figure>
                        <h3>Mike Wheeler</h3>
                        <h4>Interpretado por: Finn Wolfhard</h4>
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/dustin.jpg" alt="Dustin">
                        </figure>
                        <h3>Dustin Henderson</h3>
                        <h4>Interpretado por: Gaten Matarazzo </h4>
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/lucas.jpg" alt="Lucas">
                        </figure>
                        <h3>Lucas Sinclair</h3>
                        <h4>Interpretado por: Caleb McLaughlin </h4>
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/will.jpg" alt="Will">
                        </figure>
                        <h3>Will Byers </h3>
                        <h4>Interpretado por: Noah Schnapp </h4>
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/steve.jpg" alt="Steve">
                        </figure>
                        <h3>Steve Harrington </h3>
                        <h4>Interpretado por: Joe Keery </h4>
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/max.jpg" alt="Max">
                        </figure>
                        <h3>Max Mayfield</h3>
                        <h4>Interpretado por: Sadie Sink </h4>
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/jim.jpg" alt="Jim">
                        </figure>
                        <h3>Jim Hopper</h3>
                        <h4>Interpretado por: David Harbour </h4>
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/joyce.jpg" alt="Joyce">
                        </figure>
                        <h3>Joyce Byers</h3>
                        <h4>Interpretado por: Winona Ryder </h4>
                ...
                <li class="item-contenedor">
                    <div class="item-contenido">
                        <figure class="item-poster">
                            <img src="assets/imagenes/billy.jpg" alt="Billy">
                        </figure>
                        <h3>Billy Hargrove</h3>
                        <h4>Interpretado por: Dacre Montgomery </h4>
