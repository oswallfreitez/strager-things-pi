    ...
    <main>
        <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 fondo-noche-roja">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <h1 class="mt-6 text-center text-4xl font-bold leading-9 tracking-tight text-white">Únete a la comunidad Stranger!</h1>
            </div>
                    ...
                    <form id="registrarse" class="space-y-4" method="POST">
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="nombre" name="nombre" type="text" autocomplete="nombre" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6 px-2">
                                </div>
                            </div>
                            <div>
                                <label for="apellido" class="block text-sm font-medium leading-6 text-gray-900">Apellido</label>
                                <div class="mt-2">
                                    <input id="apellido" name="apellido" type="text" autocomplete="apellido" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6 px-2">
                                </div>
                            </div>
                        </div>
                        <div>
